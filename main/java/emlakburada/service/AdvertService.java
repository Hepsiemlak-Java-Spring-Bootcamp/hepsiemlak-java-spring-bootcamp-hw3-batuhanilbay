...
public class AdvertService {
	...
	@Autowired
	KullaniciService userService = new KullaniciService();
...
//	}
	...
	public AdvertResponse saveAdvert(AdvertRequest request) {
		...
		EmailMessage emailMessage = new EmailMessage("batuhan1234413@gmail.com");

		activeMqService.sendMessage(emailMessage,"TRY ACTIVEMQ");
